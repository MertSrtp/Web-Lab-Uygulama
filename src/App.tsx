        ...
        <section id="hakkimda" className="py-16 px-4">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
            <figure className="shrink-0">
              <img src="https://via.placeholder.com/160" alt="Mert Sarıtop vesikalık fotoğrafı" className="w-40 h-40 rounded-full object-cover shadow-lg" />
            </figure>
            <div>
              <h2 className="text-3xl font-bold mb-4 text-center md:text-left">Hakkımda</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
                Yazılım Mühendisliği öğrencisiyim. Modern web teknolojileriyle erişilebilir ve kullanıcı dostu arayüzler geliştiriyorum.
              </p>
              <ul className="flex flex-wrap gap-2">
        ...
        <section id="projeler" className="py-16 px-4 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card variant="elevated" title="E-Ticaret Sitesi" image="https://via.placeholder.com/400x200" imageAlt="E-Ticaret anasayfa görünümü">
                React ve Node.js ile geliştirilmiş tam kapsamlı e-ticaret uygulaması.
              </Card>
              <Card variant="elevated" title="Kişisel Blog" image="https://via.placeholder.com/400x200" imageAlt="Blog yönetim paneli">
                Markdown destekli, Tailwind CSS kullanılarak tasarlanmış kişisel blog platformu.
              </Card>
              <Card variant="outlined" title="Hava Durumu Uygulaması" image="https://via.placeholder.com/400x200" imageAlt="Hava durumu arayüzü">
                Kullanıcıların anlık hava durumunu takip edebileceği API entegreli uygulama.
              </Card>
            </div>
          </div>
        </section>
